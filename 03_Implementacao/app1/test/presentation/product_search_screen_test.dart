...
Widget _wrap(AppServices services, {bool canManage = true}) {
  return AppServicesScope(
    ...
    child: MaterialApp(
      ...
      home: ProductSearchScreen(cart: _cart, canManage: canManage),
    ),
  );
}
...
void main() {
  ...
  testWidgets(
    'finds an assigned product by name and shows nothing for a non-match',
    (tester) async {
      const adrenaline = Product(
        id: 'p1',
        institutionId: 'inst-a',
        name: 'Adrenalina',
      );
      const amiodarone = Product(
        id: 'p2',
        institutionId: 'inst-a',
        name: 'Amiodarona',
      );
  ...
  testWidgets('opens the assignment dialog for a search result', (
    tester,
  ) async {
